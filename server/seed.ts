...
const LIVERY_DEFAULTS = [
  ...
  { imageKey: "category_music_title", label: "Category Title - Music", defaultUrl: "", itemType: "text" as const, defaultText: "Music" },
  { imageKey: "category_music_desc", label: "Category Description - Music", defaultUrl: "", itemType: "text" as const, defaultText: "Singers, rappers, DJs & producers" },
  { imageKey: "category_modeling_title", label: "Category Title - Modeling", defaultUrl: "", itemType: "text" as const, defaultText: "Modeling" },
  { imageKey: "category_modeling_desc", label: "Category Description - Modeling", defaultUrl: "", itemType: "text" as const, defaultText: "Fashion, fitness & swimwear models" },
  { imageKey: "category_bodybuilding_title", label: "Category Title - Bodybuilding", defaultUrl: "", itemType: "text" as const, defaultText: "Bodybuilding" },
  { imageKey: "category_bodybuilding_desc", label: "Category Description - Bodybuilding", defaultUrl: "", itemType: "text" as const, defaultText: "Physique, classic & open divisions" },
  { imageKey: "category_dance_title", label: "Category Title - Dance", defaultUrl: "", itemType: "text" as const, defaultText: "Dance" },
  { imageKey: "category_dance_desc", label: "Category Description - Dance", defaultUrl: "", itemType: "text" as const, defaultText: "Hip-hop, contemporary & freestyle" },
  ...
  { imageKey: "hiw_step1_desc", label: "How It Works - Step 1 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Sign up, set up your talent profile with photos, videos, and bio. Make it stand out." },
  { imageKey: "hiw_step2_title", label: "How It Works - Step 2 Title", defaultUrl: "", itemType: "text" as const, defaultText: "Apply to Compete" },
  { imageKey: "hiw_step2_desc", label: "How It Works - Step 2 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Browse active competitions and apply to the ones that match your talent and goals." },
  { imageKey: "hiw_step3_title", label: "How It Works - Step 3 Title", defaultUrl: "", itemType: "text" as const, defaultText: "Win Public Votes" },
  { imageKey: "hiw_step3_desc", label: "How It Works - Step 3 Description", defaultUrl: "", itemType: "text" as const, defaultText: "Once approved, share your profile. The contestant with the most votes wins the crown." },
